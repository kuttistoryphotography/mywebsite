        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          <div>
            ...
            <p className="mt-8 text-gray-400 text-lg leading-8">
              Professional photography tips, wedding planning advice, real
              wedding stories, and creative inspiration from the Kutti Story
              Photography team.
            </p>
          ...
          <div className="space-y-7 text-gray-400 leading-9 text-lg">
            <p>
              ...
              pre-wedding inspiration, engagement planning advice, venue
              recommendations, and complete photography guides for couples
              across Madurai and Tamil Nadu.
            </p>

            <p>
              Whether you're planning a traditional Tamil wedding, destination
              wedding, engagement, maternity shoot, baby shower, or birthday
              celebration, our articles help you understand photography styles,
              pricing, timelines, locations, and how to prepare for your
              special day.
            </p>

            <p>
              Browse our latest articles to discover practical wedding
              checklists, pose ideas, photography trends, editing tips, and
